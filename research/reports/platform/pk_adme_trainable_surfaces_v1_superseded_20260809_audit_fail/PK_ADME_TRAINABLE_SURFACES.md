...
The release contains 675,744 source-bound endpoint observations and 642,065 rows in endpoint-specific modeling tasks. It covers 186,903 standardized molecules, 175,965 connectivity leakage groups, and 93 tasks meeting the minimum size contract.

This is a noncanonical modeling-preparation release. It creates no clinical, QT, hERG, safety, efficacy, or approval labels, and it does not promote any row into the canonical PK store.
...
- A scaffold group is also supplied for scaffold-holdout evaluation.
