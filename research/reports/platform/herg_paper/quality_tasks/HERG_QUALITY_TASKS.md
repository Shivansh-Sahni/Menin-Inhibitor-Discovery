...
- **Q2_FUNCTIONAL_ASSAY_AWARE:** 3,597 retained rows; 3,548 eligible rows,
  2,776 structures, and 49 reason-coded exclusions.
...
- Q2 preserves exact, approximate, and genuinely censored functional IC50
  relations separately from AC50, inhibition, potency, and other native
  endpoints. Clinical-QT phenotype rows and IC50 values with missing native
  relations are retained for audit but cannot become direct or training hERG
  labels. Measurement technology is a covariate and error-analysis stratum.
