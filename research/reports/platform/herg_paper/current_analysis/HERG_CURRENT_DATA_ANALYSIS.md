...
| Q2 | 3,548 | 2,776 | NA | functional assay-aware task |
...
| binding_unspecified | 10,094 | 7,981 |
...
|---|---|---|---:|---:|---:|---:|
| automation_class | automated vs unresolved | binary_consensus | 614 | 0.366 | NA | NA |
| automation_class | automated vs manual | binary_consensus | 28 | 0.893 | NA | NA |
| automation_class | manual vs unresolved | binary_consensus | 28 | 1.000 | NA | NA |
...
| automation_class | manual vs unresolved | exact_pic50_mean | 33 | NA | 0.395 | 0.964 |
| automation_class | automated vs manual | exact_pic50_mean | 32 | NA | 1.056 | 0.741 |
| automation_class | automated vs unresolved | exact_pic50_mean | 31 | NA | 0.801 | 0.761 |
...
- Use the master assay-protocol index to stratify reported cell system,
  temperature, voltage, time/incubation, recording configuration, and named
  platform; extend it only where additional source text supports new values.
...
Schema `platform-herg-current-analysis/1.1`; RDKit `2026.03.3`. All Parquet outputs and their SHA-256 digests are recorded in the manifest. Inputs are content-bound; upstream artifacts are not modified.
